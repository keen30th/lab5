    ...
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? id, int? bookID)
        {
            ...
            if (id != null)
            {
                ...
                Publisher publisher = viewModel.Publishers.FirstOrDefault(i => i.ID == id.Value);
                if (publisher != null)
                {
            ...
            if (bookID != null)
            {
                ...
                Book selectedBook = viewModel.Books.FirstOrDefault(x => x.ID == bookID.Value);
                if (selectedBook != null)
                {
                    viewModel.Orders = selectedBook.Orders;
                }
            }
